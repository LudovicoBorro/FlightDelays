...
class Model:
    ...
    def _ricorsione(self, parziale, v1, t):
        ...
        if parziale[-1] == v1: # Potenzialmente questa è una soluzione accettabile
    ...
    def _getScore(self, soluzione_potenziale):
        somma = 0
        for i in range(0, len(soluzione_potenziale)-1):
            somma += self._graph[soluzione_potenziale[i]][soluzione_potenziale[i+1]]['weight']
        return somma
    ...
    def addEdges(self):
        ...
        # Queste tratte hanno 2 problemi: i) ho archi diretti e inversi,
    ...
    def hasPath(self, v0, v1):
        # Restituisce True se un qualche cammino tra v0 e v1 esiste, altrimenti restituisce False
